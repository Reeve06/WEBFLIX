...

{
  ...
  foreach ( $_POST['qty'] as $id => $sub_qty )
  {
...
# Retrieve booking in the cart from the 'plans' database table.
...
<label for=\"plans_title\" class=\"col-sm-12 col-form-label\">Subscription Type:    {$row['plans_title']}</label> 
</div>
</li>
       <li class=\"list-group-item\">
 <div class=\"form-group row\">
...
<li class="list-group-item">
<a href="checkout.php?total='.$total.'"><button type="button" class="btn btn-secondary btn-block" role="button">Subscribe Now</button></a>
</li>
</ul>
</form>
</div></div></div></div></div>  ';  }
...
echo '<div class="container">
	...
	<h2>No subscription have been made.</h2>
